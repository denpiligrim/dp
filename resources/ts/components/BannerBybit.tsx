...
const BannerBybit = () => {
  ...
  return (
    <Box p={2} sx={{ width: '100%', position: 'relative' }}>
      <a href="https://www.bybit.com/invite?ref=5VYEOKM" target="_blank" rel="noopener noreferrer">
        <Box className={i18n.language === 'ru' ? 'ruBannerBybit' : 'enBannerBybit'}></Box>
      </a>
